...
SALIDAS_ESPERADAS = (
    ...
    "figura01_perfil_categorias.png",
    "figura02_volumen_gestiones.png",
    "figura03_unidad_analisis.png",
    "figura04_muestra_sensibilidad.png",
    "figura05_linea_de_tiempo.png",
    "figura06_origenes_rodantes.png",
    "figura07_d_descompuesta.png",
